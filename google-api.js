...
This module is adapted from the boilerplate API code and Google's `api.js`

api.js: https://apis.google.com/js/api.js

Boilerplate: https://developers.google.com/youtube/v3/docs/channels/list
